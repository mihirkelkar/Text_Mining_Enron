...
features_list = ["poi", "salary","bonus", "email_from_poi", "email_to_poi",'deferral_payments', 'total_payments','loan_advances', 'restricted_stock_deferred','deferred_income', 'total_stock_value', 'expenses', 'exercised_stock_options','long_term_incentive', 'shared_receipt_with_poi', 'restricted_stock', 'director_fees']
...
prediction = nb.predict(features_test)
accuracy = accuracy_score(prediction,labels_test)
print accuracy

print "NB Allgorithm time is", time.time() - time_start
